...
| 67 | `tests/audit/test_endpoint_credential_foundation.py` (en implementación) | `67 | Repository | Endpoint Credential Foundation | Static Security Audit` | INFRA-BLOCKED run 34679549816: static audit PASS; runner LAB y guards PASS; DDL bloqueado por MySQL 1142 para asteriskuser sin CREATE; rollback obligatorio sin cambios persistentes. Pendientes: helper DBA allowlisted, reejecución DDL, override por MAC, importación, rotación/rollback completa y consumo del vendor. |
