...
| 71 | `prod-endpoint-credential-test71.yml` | `71 | Ceiba Production | Endpoint Credentials | Controlled Runtime Install` | STAGED / `NOT-TESTED`. Workflow manual-only activo en `main` desde commit `7aba3f2ed5a78cf8d0433283d592ec20043b5acf`, candidato pinneado `ef176c99935af5f833248358c4daf7b4ca0dde6a` / helper blob `3c16593a0f2490e00ad912838ec32eed2b35e26a`. Requiere helper root-owned dedicado + sudoers exacto instalados una sola vez; verifica grants DDL limitados, instala esquema/clave/runtime con backup y rollback solo de runtime; no contacta teléfonos. |
