...
| 71 | `prod-endpoint-credential-test71.yml` | `71 | Ceiba Production | Endpoint Credentials | Controlled Runtime Install` | STAGED / `NOT-TESTED`. Workflow manual-only activo en `main` desde commit `6b9cfa9b87be72173d74519d1e6e77ed88f21682`, candidato pinneado `8458bd3d194c607363179569ee1f4ef2208c5061` / helper blob `ea5dce972dd436b4ff2a70e940e6b635d2a039b5`. Requiere helper root-owned dedicado + sudoers exacto instalados una sola vez; instala esquema/clave/runtime con backup y rollback solo de runtime; no contacta teléfonos. |
