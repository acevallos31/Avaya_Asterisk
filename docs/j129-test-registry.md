...
| 49 | `lab-j129-physical-call-e2e.yml` | `49 | Issabel Lab | J129 Physical Call | Controlled E2E` | PREPARADA. Réplica LAB de Test 47 con helper restringido; detecta cuenta J129 desde Endpoint Configurator, usa IP LAB configurable y origina `Playback hello-world`. Pendiente instalar helper/sudoers y ejecutar preflight/call con confirmación física. |
