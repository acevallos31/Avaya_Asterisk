...
| 66 | `lab-grandstream-grp2601p-configure.yml` | `66 | Issabel Lab | GRP2601P | Configure & End-to-End Audit` | `LAB-INTEGRATION-PASS` run `34677554254`: recuperación de etapa, patch GRP26xx reversible, Apply Issabel, cfg/XML, cuenta SIP 203 y registro desde `.176`, HTTP 200; 201/202 no desplazadas. Run `34671167798` fue `HARNESS-FAIL` por probe sin `/cgi-bin`; corregido con rollback incluso cuando Issabel retorna 0. Validación física de llamada/audio pendiente. |
