...
| 55 | `lab-grandstream-test55-factory-reset.yml` | `55 | Issabel Lab | GXP1625 Factory Reset | Controlled Test` | FACTORY RESET PASS / E2E MANUAL PENDIENTE. Run `34541419730`: reset exacto observado (HTTP down/up); el endpoint reapareció por discovery. Run read-only `34542431592`: una fila Grandstream/GXP1625 en `.168`, sin cuenta, override ni cfg; 201/202 preservadas. Push solo audita; repetir reset exige dispatch y confirmación exacta. Pendiente asignar 202/Ashly en Endpoint Configurator y validar provisioning/SIP/llamada. |
