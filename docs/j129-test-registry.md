...
| 56 | `lab-grandstream-gxp1630-probe.yml` | `56 | Issabel Lab | Grandstream GXP1630 | Factory-State Discovery` | `LAB-READ-PASS`, run `34578860986`. Coincidencia única: `192.168.1.169`, `C0:74:AD:B4:AD:70`, GXP1630. `/manager` no respondió; `api.values.get` sí. Confirma detección moderna, no aún login/provisioning. No configuró ni reinició el teléfono. |
