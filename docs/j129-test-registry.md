...
| 57 | `lab-grandstream-gxp1630-cycle.yml` | `57 | Endpoint Lab | GXP1630 | Controlled Provisioning Cycle` | PASS run `34584178016`: bootstrap P212/P237, reinicio y retorno HTTP. |
...
| 64 | `lab-grandstream-grp2601p-auth-read.yml` | `64 | Endpoint Lab | GRP2601P | Authenticated Provisioning Read` | `CREDENTIAL-BLOCKED` run `34620889592`. Runs `34628195632`/`34628373795`: secreto equivocado; no autoritativos. Run `34642689024`: `GRANDSTREAM_GXP1625_HTTP_PASSWORD` rechazado. Runs `34647374500`/`34647476040`: secret MAC-bound `GRANDSTREAM_GRP2601P_EC74D71EE8E3_HTTP_PASSWORD` presente, identidad exacta y HTTP 200, pero respuesta de login `ERROR` con cuerpo string; rechazo explícito, no fallo de parser. Sin escrituras, reinicio, provisioning ni firmware upgrade. Pendiente verificar/copiar nuevamente la contraseña de etiqueta. |
